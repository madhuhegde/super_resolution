...
from ..utils.output import BaseOutput, BaseModel
#from ..utils.accelerate_utils import apply_forward_hook
#from ..utils.modeling_utils import ModelMixin
...
class VAEDecoder(BaseModel):  
    ...
    def __init__(
        ...
        print("in_channels={},out_channels={},up_block_types={}, block_out_channels={}, layers_per_block={}, act_fn={},latent_channels={}".format(in_channels,out_channels,up_block_types, block_out_channels, layers_per_block, act_fn,latent_channels))
        print("latent_channels={}, sample_size={},num_vq_embeddings={}, norm_num_groups={}, vq_embed_dim ={},scaling_factor={},norm_type={}".format(latent_channels, sample_size,num_vq_embeddings, norm_num_groups, vq_embed_dim,scaling_factor,norm_type)) 
