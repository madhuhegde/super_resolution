...
class DepsTableUpdateCommand(Command):
    ...
    user_options = [
        ...
        (
            "dep-table-update",
            None,
            "updates dependency_versions_table.py",
        ),
    ]
    ...
    def run(self):
        ...
        target = "dependency_versions_table.py"
...
setup(
    ...
    version="0.1.1.dev0",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
    ...
    author_email=" ",
    url="https://github.com/madhuhegde/super_resolution",
    package_dir={"": "latent_diffusion"},
	packages=find_packages("latent_diffusion"),
    python_requires=">=3.8.0",
    install_requires=list(install_requires),
    extras_require=extras,
    entry_points={"console_scripts": ["latent_diffusion-cli=latent_diffusion.commands.latent_diffusion_cli:main"]},
    classifiers=[
